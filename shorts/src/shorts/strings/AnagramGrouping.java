...
/**
 * The task of Anagram Grouping involves grouping words that are anagrams of each other.
 * An anagram is a word or phrase formed by rearranging the letters of another, such as "rat" and "tar".
 */
